...
# countdown
countdown() {
	for sec in $(seq $take -1 1); do
		notify-send -h string:x-canonical-private-synchronous:shot-notify -t 1000 -i "$directory"/timer.png "Taking shot in : $sec"
		sleep 1
	done
}
